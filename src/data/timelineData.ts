...
const timelineData: TimelineEra[] = [
  {
    ...
    cards: [
      ...
      { image: "/images/timeline/60/kid1.jpg", text: "יסקרן אוהב להסתגר בחדר ולקרוא ספרים" },
      { image: "/images/timeline/60/kid2.jpg", text: "ילד טוב ואחראי שלא מסתבך ולא שובר איברים" },
      { image: "/images/timeline/70/teen1.jpg", text: "ג'ינסים מתרחבים, שיער ארוך, והכרזה ראשונה על עצמאות: 'אני הולך ברגל לבית ספר'." },
  ...
  },
  {
    ...
    cards: [
      ...
      { image: "/images/timeline/80/presentor.png", text: "רוקסטאר בעולם המחשבים של שנת 1988, נבחרת לדגמן לקמפיין של טרה סיס – כולל בגדי ים אופנתיים!" }
    ]
  },
  {
